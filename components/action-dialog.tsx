    ...
    return (
      <Dialog>
        <DialogTrigger asChild>
          <Button
            variant={"outline"}
            className="flex items-center justify-center rounded-full text-red-500 cursor-pointer"
          >
    ...
    return (
      <Dialog>
        <DialogTrigger asChild>
          <Button
            variant="outline"
            className="flex items-center justify-center rounded-full text-blue-600/80 hover:underline cursor-pointer"
          >
            View
          </Button>
        </DialogTrigger>
