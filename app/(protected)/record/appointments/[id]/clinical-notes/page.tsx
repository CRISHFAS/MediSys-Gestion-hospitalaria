...
export default async function ClinicalNotesPage({
        ...
        <div className="bg-white rounded-xl p-6">
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-500">
              Esta cita ya se ha completado y se han registrado las notas clínicas.
            </p>
            <Link
              href={`/record/appointments/${id}`}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl p-6 border">
        <div className="mb-6">
          <h2 className="text-lg font-semibold">Ingresar notas clínicas</h2>
          <p className="text-sm text-gray-600 mt-1">
            Complete el formulario a continuación para registrar las notas clínicas de esta cita.
          </p>
        </div>
