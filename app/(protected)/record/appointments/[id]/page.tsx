    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold"># citas{id}</h1>
        </div>
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="font-medium mb-2">Detalles del paciente</h3>
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-lg font-semibold mb-4">Información del médico</h2>
              <div className="flex items-center gap-4">
                <ProfileImage
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <span className="text-sm text-gray-600">Typo</span>
              <div className="mt-1">
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm">
        ...
        {appointmentData.status === "COMPLETED" ? (
          <div className="text-center py-8 text-gray-500">
            <p>Los registros médicos se mostrarán aquí una vez creados.</p>
            <p className="text-sm mt-2">
              Utilice el botón "Agregar notas clínicas" de arriba para crear registros médicos.
            </p>
          </div>
        ) : (
          <div className="text-center py-8 text-gray-500">
            <p>No se encontraron registros médicos para esta cita.</p>
            <p className="text-sm mt-2">
              Los registros médicos aparecerán aquí una vez completada la cita.
            </p>
          </div>
        )}
      </div>
        ...
        {billing.success && billing.data ? (
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <span className="text-sm text-gray-600">Cantidad pagada</span>
            ...
            {billing.data.bills && billing.data.bills.length > 0 && (
              <div>
                <h4 className="font-medium mb-2">Artículos de factura</h4>
          ...
          <div className="text-center py-8 text-gray-500">
            <p>No se encontró información de facturación para esta cita.</p>
            <p className="text-sm mt-2">
              {appointmentData.status === "COMPLETED"
                ? "Crea una factura utilizando el botón de arriba."
                : "Los detalles de facturación aparecerán aquí una vez que se complete la cita."}
            </p>
          </div>
        )}
      </div>
