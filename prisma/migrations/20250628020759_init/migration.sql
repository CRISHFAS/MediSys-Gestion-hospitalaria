/*
  ...
  - You are about to drop the column `insurance_policy_number` on the `Patient` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Patient" DROP COLUMN "insurance_policy_number",
